...
class TampilPasien implements KontrakView
{
	...
	{
		// Form HTML
		$form = "<input hidden name='action' value='addPasien'>
		<div class='container' style='border: 2px solid #ddd; padding: 20px; background-color: #f9f9f9;'>
		<h3 style='text-align: center;'>Add New Pasien</h3>
		<div class='form-group'>
			<div class='form-group'>
			<label for='NIK'>NIK</label>
			<input type='text' class='form-control' name='nik' style='outline: none;'>
			</div>
			<div class='form-group'>
			<label for='Nama'>Nama</label>
			<input type='text' class='form-control' name='nama' style='outline: none;'>
			</div>
			<div class='form-group'>
			<label for='Tempat'>Tempat</label>
			<input type='text' class='form-control' name='tempat' style='outline: none;'>
			</div>
			<div class='form-group'>
			<label for='TL'>Tanggal Lahir</label>
			<input type='date' name='tl' class='form-control' style='outline: none;'>
			</div>
			<div class='form-group'>
				<label for='Gender'>Gender</label>
			<select name='gender' class='form-control' style='outline: none;'>
			...
			<div class='form-group'>
				...
				<input type='email' name='email' class='form-control' style='outline: none;'>
			</div>
			<div class='form-group'>
			<label for='Telp'>No. Telepon</label>
			<input type='text' name='telp' class='form-control' style='outline: none;'>
			</div>
		</div>";
